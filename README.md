...
- `hn-to-x-poster`: Review the current top Hacker News stories, select software or AI items, and publish a short Chinese summary to X from an already logged-in browser session.
